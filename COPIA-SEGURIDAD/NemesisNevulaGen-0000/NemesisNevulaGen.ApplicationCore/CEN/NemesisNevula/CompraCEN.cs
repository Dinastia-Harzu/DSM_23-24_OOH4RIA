...
public int CrearCompra (Nullable<DateTime> p_fecha, int p_usuarioComprador, int p_articulo, float p_precioTotal, Nullable<DateTime> p_fechaCaducidad, bool p_regalado, int p_usuarioReponedor)
{
