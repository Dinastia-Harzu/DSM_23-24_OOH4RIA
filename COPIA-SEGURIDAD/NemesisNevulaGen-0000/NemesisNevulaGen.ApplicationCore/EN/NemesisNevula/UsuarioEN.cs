...
/**
 *	Atributo compraRegalo
 */
private System.Collections.Generic.IList<NemesisNevulaGen.ApplicationCore.EN.NemesisNevula.CompraEN> compraRegalo;



/**
 *	Atributo compraMonedero
 */
private System.Collections.Generic.IList<NemesisNevulaGen.ApplicationCore.EN.NemesisNevula.CompraEN> compraMonedero;
...
public virtual System.Collections.Generic.IList<NemesisNevulaGen.ApplicationCore.EN.NemesisNevula.CompraEN> CompraRegalo {
        get { return compraRegalo; } set { compraRegalo = value;  }
}



public virtual System.Collections.Generic.IList<NemesisNevulaGen.ApplicationCore.EN.NemesisNevula.CompraEN> CompraMonedero {
        get { return compraMonedero; } set { compraMonedero = value;  }
}
...
public UsuarioEN()
{
        ...
        compraRegalo = new System.Collections.Generic.List<NemesisNevulaGen.ApplicationCore.EN.NemesisNevula.CompraEN>();
        compraMonedero = new System.Collections.Generic.List<NemesisNevulaGen.ApplicationCore.EN.NemesisNevula.CompraEN>();
}
...
{
        this.init (Id, nombre, correo, conGoogle, foto_perfil, articulosFavs, puntosNevula, compraUsuario, metodoPago, articulo, cartera, valoracionArticulo, pass, compraRegalo, compraMonedero);
}


public UsuarioEN(UsuarioEN usuario)
{
        this.init (usuario.Id, usuario.Nombre, usuario.Correo, usuario.ConGoogle, usuario.Foto_perfil, usuario.ArticulosFavs, usuario.PuntosNevula, usuario.CompraUsuario, usuario.MetodoPago, usuario.Articulo, usuario.Cartera, usuario.ValoracionArticulo, usuario.Pass, usuario.CompraRegalo, usuario.CompraMonedero);
}
