...
public int CrearPaypal (System.Collections.Generic.IList<int> p_usuarioPoseedor, string p_email, String p_pass)
{
        ...
        paypalEN.UsuarioPoseedor = new System.Collections.Generic.List<NemesisNevulaGen.ApplicationCore.EN.NemesisNevula.UsuarioEN>();
        if (p_usuarioPoseedor != null) {
                foreach (int item in p_usuarioPoseedor) {
                        ...
                        en.Id = item;
                        paypalEN.UsuarioPoseedor.Add (en);
                }
        }
