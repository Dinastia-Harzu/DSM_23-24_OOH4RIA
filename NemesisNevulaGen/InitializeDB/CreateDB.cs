...
public static void InitializeData ()
{
        try
        {
                ...
                int idAdmin = administradorcen.CrearAdmin ("Federico Alfredo", "fnaf1@gmail.com", false, "/FotosPerfil/te.jpeg", 12, (float)1.25, "contrasenya");
                int idUsuarioPremium = usuariopremiumcen.CrearUsuarioPremium ("Bonifacio Conejal", "fnaf2@gmail.com", true, "/FotosPerfil/na.jpeg", 2, (float)0.00, "pwd123", DateTime.Now.AddMonths (3));
                int idUsuario = usuariocen.CrearUsuario ("Chica Gallina", "fnaf3@gmail.com", true, "/FotosPerfil/ge.jpeg", 2, (float)12.5, "pwd123");
                ...
                int idNoticia1 = noticiacen.CrearNoticia (noti, false, "Nuevos artículos!", "/css/estilos/imagenes/pe.jpeg");
                int idNoticia2 = noticiacen.CrearNoticia (noti, true, "Próximas temporadas", "/css/estilos/imagenes/contactanos.jpeg");
                int idNoticia3 = noticiacen.CrearNoticia (noti, true, "Cósmico y universal", "/css/estilos/imagenes/pp.jpeg");
