...
public static void InitializeData ()
{
        try
        {
                ...
                int idusr = usuariocen.CrearUsuario ("Bonifacio Conejal", "fnaf2@gmail.com", true, "na.jpeg", 2, (float)0.00, "pwd123");
...
/*
                ...
                int idArticulo1 = articulocen.CrearArticulo("Guitarra espacial", "a", (float)0.0, "ge.jpeg", NemesisNevulaGen.ApplicationCore.Enumerated.NemesisNevula.RarezaArticuloEnum.Premium, NemesisNevulaGen.ApplicationCore.Enumerated.NemesisNevula.TipoArticuloEnum.Animacion, 0, false, DateTime.Now, "fnaf pelicula", "ge.jpeg");
                int idArticulo2 = articulocen.CrearArticulo("Pistola estelar", "a", (float)0.0, "pe.jpeg", NemesisNevulaGen.ApplicationCore.Enumerated.NemesisNevula.RarezaArticuloEnum.Comun, NemesisNevulaGen.ApplicationCore.Enumerated.NemesisNevula.TipoArticuloEnum.Arma, 0, true, DateTime.Now.AddMonths(94), "fnaf pelicula", "pe.jpeg");

                int idTarjeta1 = tarjetacreditocen.CrearTarjetaCredito(idusr, NemesisNevulaGen.ApplicationCore.Enumerated.NemesisNevula.TipoTarjetaEnum.Mastercard, "Chica", "5555777788889999", DateTime.Now.AddMonths(3), "aaaa");
                int idPayPal1 = tarjetacreditocen.CrearTarjetaCredito(idusr, NemesisNevulaGen.ApplicationCore.Enumerated.NemesisNevula.TipoTarjetaEnum.Mastercard, "Chica", "5555777788889999", DateTime.Now.AddMonths(3), "aaaa");

                UsuarioCP compraCP = new UsuarioCP (new SessionCPNHibernate ());

                int idCompra1 = compraCP.ComprarArticulo(idusr, idArticulo1, false);
                int idCompra2 = compraCP.ComprarArticulo(idusr, idArticulo2, false);
                ...
                UsuarioPremiumEN idUsuarioPremium = usuarioPremiumCP.CrearUsuarioPremium ("Bonifacio Conejal", "fnaf2@gmail.com", true, "na.jpeg", 2, (float)10.00, "pwd123");
...
*/
                 ...
                 * usuario_af = usuariocen.CrearUsuario ("Arturo", "agrg11@alu.ua.es", false, "https://picsum.photos/200", 100, 25, "password");
